...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        const phoneLimpo = phoneInput.value.replace(/\D/g, '');
        ...
        if (phoneLimpo && !validarTelefone(phoneLimpo)) {
            mostrarErro('Telefone inválido');
            return;
        }

        // Remove máscaras diretamente nos inputs
        documentInput.value = docLimpo;
        phoneInput.value = phoneLimpo;
